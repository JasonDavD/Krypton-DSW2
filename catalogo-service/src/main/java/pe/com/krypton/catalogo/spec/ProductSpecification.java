package pe.com.krypton.catalogo.spec;
...
public final class ProductSpecification {
     ...
     * ADAPTACIÓN MICROSERVICIOS: `category_id` es una columna plana (sin relación),
     * por eso el predicado va contra el atributo `categoryId` directamente.
     */
